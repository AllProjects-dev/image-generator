...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/image-generator)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/image-generator
```

A live public deployment of this template is available at [https://image-generator.templates.workers.dev](https://image-generator.templates.workers.dev)
